...
void init_comunication(){
  ...
  // if(SELF_ID == 1){
  //   Payload p2;
  //   p2.payload_report = {1,2,3};
  //   Msg* m2 = create_msg(1,0,type_report,p2);
  //   send_msg_to_master(m2);
  // }
  ...
  // while(SELF_ID == 1){ //report msg??
  //   Payload p1;
  //   strcpy(p1.payload_command_01.str1, "aaa"); 
  //   strcpy(p1.payload_command_01.str2, "bbb");
  //   Msg* m1 = create_msg(1, 0, type_command_01, p1);
  //   send_msg_to_master(m1);
