...
const int PING_SLAVE_WAIT_FOR_ACK_MAX_DELAY = 2000; //! fix: do alle schedine 5s per rispondere ad un hanshake invece che 2s
const int PING_MASTER_WAIT_FOR_ACK_MAX_DELAY = 2000;

const int PING_SLAVE_SEND_NEW_HANDSHAKE_DELAY = 2000;
const int PING_MASTER_SEND_NEW_HANDSHAKE_DELAY = 2000;
